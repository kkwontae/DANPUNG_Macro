...
namespace DANPUNG
{
    public partial class addStringCopy : Form
    {
        public addStringCopy()
        {
            InitializeComponent();
        ...
        //private string Hangel(string data)
        //{
        //    int a, b, c;
        //    string result = "";
        ...
        {
            txtStringItem.Text = "Text '" + txtCopyString.Text + "', " + txtDelay.Text + "ms";
            txtStringCode.Text = "！" + txtCopyString.Text + "？" + txtDelay.Text;
        }

        public string getItem()
        {
            return txtStringItem.Text;
        }

        public string getCode()
        {
            return txtStringCode.Text;
        }

        public class EngHanConverter
        {
            // https://ryuanerin.kr/post/2016-02-18-eng-kor //
